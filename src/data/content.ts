...
export const HEADLINES: NewsItem[] = [
  {
    ...
    tag: "Crise Política",
    title:
      "Baderna é a nova tática da oposição: Guerra de rua para “Impeachment” de Jango",
  ...
  },
  {
    ...
    tag: "Repressão",
    title:
      "JUSTIÇA MILITAR CONDENA A 187 ANOS DE PRISÃO 27 SUBVERSIVOS: RECIFE",
  ...
  },
  {
    ...
    title:
      "JORNAL CORREIO BRAZILIENSE (DF) - EDITORIAL - EM DEFESA DA JUVENTUDE",
    ...
    context:
      "A manchete surge em um momento em que o governo ampliava o uso do discurso de segurança nacional para diferentes temas do cotidiano. O combate às drogas passou a ser tratado como prioridade estratégica, justificando medidas mais rígidas. Esse enquadramento reforçava a ideia de vigilância e controle presente no período. Ver mais em: Jornal Correio Braziliense, N° 3.351, Distrito Federal, 13 de novembro de 1970.",
    sourceUrl:
      "https://memoria.bn.gov.br/DocReader/DocReader.aspx?bib=028274_02&hf=memoria.bn.gov.br&pagfis=6511",
    alignment: "PRO_GOVERNMENT",
    canAlter: false,
  ...
  },
  {
    ...
    context:
      "Durante a ditadura, não era raro que jornalistas simplesmente “sumissem” após ações da Polícia Federal. O caso desses dois editores presos em Goiás revela como a busca por informações virava um jogo de esconde-esconde sombrio. Ver mais em: Jornal do Brasil, N° 84, Rio de Janeiro, 1 de julho de 1975.",
    sourceUrl:
      "https://memoria.bn.gov.br/DocReader/DocReader.aspx?bib=030015_09&Pesq=carta&id=3510401088635&pagfis=58104",
    alignment: "PRO_PEOPLE",
    canAlter: false,
  ...
  },
  {
    ...
    tag: "Censura",
    title:
      "Jornal do Brasil (RJ) - Cartas - Censura (I), 10 de fevereiro de 1977",
    ...
    sourceUrl:
      "https://memoria.bn.gov.br/DocReader/DocReader.aspx?bib=030015_09&hf=memoria.bn.gov.br&pagfis=90455",
    alignment: "PRO_PEOPLE",
    canAlter: false,
  ...
  },
  {
    ...
    context:
      "A manchete aparece num momento em que o país acompanhava, com cautela, os sinais de abertura política anunciados pelo governo. Mesmo após intervenções em sindicatos e outras tensões, autoridades buscavam reforçar que o processo continuaria. Ver mais em: Jornal do Brasil, N° 347, Rio de Janeiro, 25 de março de 1979.",
    sourceUrl:
      "https://memoria.bn.gov.br/DocReader/DocReader.aspx?bib=030015_09&Pesq=Diretas%20j%C3%A1&id=3510401088635&pagfis=136782",
    alignment: "PRO_GOVERNMENT",
    canAlter: false,
...
export const FILLERS: NewsItem[] = [
  {
    ...
    context:
      "A instabilidade econômica era usada tanto para atacar o governo anterior quanto para justificar medidas duras do novo regime.",
  ...
  },
  {
    ...
    context:
      'O futebol servia como uma importante "válvula de escape" e distração política.',
  ...
  },
  {
    ...
    editionTitle: "Edição Diária",
    tag: "Crise Política",
    title: "Goulart Criticado no México",
    body: "CIDADE DO MÉXICO, 18 (UPI) - O Daily “Excelsior”, conservador, independente criticou hoje o projeto do Presidente brasileiro João Goulart para legalizar o partido comunista.",
    context: "A notícia mostra como um jornal estrangeiro critica, às vésperas do golpe de 1964, sobre a intenção atribuída ao governo João Goulart de legalizar o Partido Comunista. Ver mais em: Jornal Correio Braziliense, N° 1174, Distrito Federal, 19 de março de 1964.",
    sourceUrl: "https://memoria.bn.gov.br/DocReader/DocReader.aspx?bib=028274_01&hf=memoria.bn.gov.br&pagfis=13750",

    canAlter: true,

    publishImpact: { money: +30, censor: -5, public: +15 },
    censorImpact: { money: -20, censor: 0, public: -10 },

    alterOptions: [
      {
        id: "alt-f-03-gmx-1",
        text: "CIDADE DO MÉXICO, 18 (UPI) - O Daily “Excelsior” comentou a movimentação política no Brasil, destacando como os debates atuais têm mobilizado positivamente a população.",
        title: "Goulart Criticado no México",
        impactModifier: { money: +30, censor: -15, public: +5 },
      },
      {
        id: "alt-f-03-gmx-2",
        text: "CIDADE DO MÉXICO, 18 (UPI) - A imprensa mexicana demonstrou curiosidade com a intensa participação do povo brasileiro nas discussões políticas recentes.",
        title: "Goulart Criticado no México",
        impactModifier: { money: +30, censor: -15, public: +5 },
      },
      {
        id: "alt-f-03-gmx-3",
        text: "CIDADE DO MÉXICO, 18 (UPI) - A imprensa estrangeira notou como o público brasileiro segue atento e engajado às decisões do governo.",
        title: "Goulart Criticado no México",
        impactModifier: { money: +30, censor: -15, public: +5 },
      },
    ],
...
export const LETTERS: Letter[] = [
  {
    ...
    newsReward: {
      ...
      context:
        "Fake news e propaganda anticomunista eram disseminadas amplamente.",
